...
|---|---|---|---|---|
| A10/A01 | tileserver | **T-3**: los assets del MosaicJSON no pasan por el filtro anti-SSRF **ni por la comparación de tenant** (M.8.1) | Alto **si** el mosaico pasa a servirse por HTTP | Decidir `PREGUNTAS_ABIERTAS` A-1 primero |
